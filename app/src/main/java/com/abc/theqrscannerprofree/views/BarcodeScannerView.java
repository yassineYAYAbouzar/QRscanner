...
import com.abc.theqrscannerprofree.utils.UtilsCameraEnd;
import com.abc.theqrscannerprofree.utils.JavaClassThread;
import com.abc.theqrscannerprofree.utils.PreviewUtils;
import com.abc.theqrscannerprofree.utils.CameraWrapperUtils;
import com.abc.theqrscannerprofree.utils.IViewFinder;
...
public abstract class BarcodeScannerView extends FrameLayout implements Camera.PreviewCallback  {
    ...
    private JavaClassThread mCameraHandlerThread;
    ...
    protected IViewFinder createViewFinderView(Context context) {
        ClassViewHaveView classViewHaveView = new ClassViewHaveView(context);
        classViewHaveView.setBorderColor(mBorderColor);
        classViewHaveView.setLaserColor(mLaserColor);
        classViewHaveView.setLaserEnabled(mIsLaserEnabled);
        classViewHaveView.setBorderStrokeWidth(mBorderWidth);
        classViewHaveView.setBorderLineLength(mBorderLength);
        classViewHaveView.setMaskColor(mMaskColor);

        classViewHaveView.setBorderCornerRounded(mRoundedCorner);
        classViewHaveView.setBorderCornerRadius(mCornerRadius);
        classViewHaveView.setSquareViewFinder(mSquaredFinder);
        classViewHaveView.setViewFinderOffset(mViewFinderOffset);
        return classViewHaveView;
    }
    ...
    public void startCamera(int cameraId) {
        if(mCameraHandlerThread == null) {
            mCameraHandlerThread = new JavaClassThread(this);
        }
    ...
    public void startCamera() {
        startCamera(UtilsCameraEnd.getDefaultCameraId());
    }
    ...
    public void setFlash(boolean flag) {
        mFlashState = flag;
        if(mCameraWrapper != null && UtilsCameraEnd.isFlashSupported(mCameraWrapper.mCamera)) {
