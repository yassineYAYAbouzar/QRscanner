...
public class ClassViewHaveView extends View implements IViewFinder {
    ...
    public ClassViewHaveView(Context context) {
        super(context);
        init();
    }

    public ClassViewHaveView(Context context, AttributeSet attributeSet) {
