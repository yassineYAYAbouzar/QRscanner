...
public class NxtOneUsingScannerView extends BarcodeScannerView {
    private static final String TAG = "NxtOneUsingScannerView";
    ...
    public NxtOneUsingScannerView(Context context) {
        super(context);
        initMultiFormatReader();
    }

    public NxtOneUsingScannerView(Context context, AttributeSet attributeSet) {
