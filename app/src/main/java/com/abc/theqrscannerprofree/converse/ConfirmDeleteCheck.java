...
public class ConfirmDeleteCheck implements InterfaceConstan {
    private static View view;
    private static TextView textView;
    private static OnClickListener mOnClick;

    public interface OnClickListener {
        void onClick(List<TheQrItemCodes> callRecordItemList);
    }

    public static void showDeleteCheckCodeConfirmDialog(final Context context, final List<TheQrItemCodes> callRecordItemList, OnClickListener onClick) {
        mOnClick = onClick;
