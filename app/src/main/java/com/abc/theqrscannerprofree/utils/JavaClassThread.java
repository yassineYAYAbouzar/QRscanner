...
import com.abc.theqrscannerprofree.views.BarcodeScannerView;
...
public class JavaClassThread extends HandlerThread {

    private BarcodeScannerView mScannerView;

    public JavaClassThread(BarcodeScannerView scannerView) {
    ...
    public void startCamera(final int cameraId) {
        ...
        localHandler.post(new Runnable() {
            @Override
            public void run() {
                final Camera camera = UtilsCameraEnd.getCameraInstance(cameraId);
