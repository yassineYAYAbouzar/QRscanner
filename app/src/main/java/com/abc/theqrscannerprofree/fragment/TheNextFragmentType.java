...
public class TheNextFragmentType extends TheNextFragmentBs implements InterfaceConstan, View.OnClickListener{
    ...
    public static Fragment newInstance(int codeType, int backType, OnChangeType onChange) {
        Fragment fragment = new TheNextFragmentType();
    ...
    private void setStyle() {
        NamedPaintHlp.setIconsColors(listenerActivity, rootView, R.id.code_type_text_cb_ic, R.drawable.ic_baseline_check_24);
        NamedPaintHlp.setIconsColors(listenerActivity, rootView, R.id.code_type_barcode_cb_ic, R.drawable.ic_baseline_check_24);
        NamedPaintHlp.setIconsColors(listenerActivity, rootView, R.id.code_type_wifi_cb_ic, R.drawable.ic_baseline_check_24);
        NamedPaintHlp.setIconsColors(listenerActivity, rootView, R.id.code_type_geo_cb_ic, R.drawable.ic_baseline_check_24);
        NamedPaintHlp.setIconsColors(listenerActivity, rootView, R.id.code_type_web_link_cb_ic, R.drawable.ic_baseline_check_24);
        NamedPaintHlp.setIconsColors(listenerActivity, rootView, R.id.code_type_contact_cb_ic, R.drawable.ic_baseline_check_24);

        NamedPaintHlp.setIconsColors(listenerActivity, rootView, R.id.code_type_text_ic, R.drawable.ic_baseline_text_fields_24);
        NamedPaintHlp.setIconsColors(listenerActivity, rootView, R.id.code_type_barcode_ic, R.drawable.code_type_barcode_ic);
        NamedPaintHlp.setIconsColors(listenerActivity, rootView, R.id.code_type_wifi_ic, R.drawable.code_type_wifi_ic);
        NamedPaintHlp.setIconsColors(listenerActivity, rootView, R.id.code_type_geo_ic, R.drawable.ic_baseline_map_24);
        NamedPaintHlp.setIconsColors(listenerActivity, rootView, R.id.code_type_web_link_ic, R.drawable.ic_baseline_link_24);
        NamedPaintHlp.setIconsColors(listenerActivity, rootView, R.id.code_type_contact_ic, R.drawable.code_type_contact_ic);
    }
