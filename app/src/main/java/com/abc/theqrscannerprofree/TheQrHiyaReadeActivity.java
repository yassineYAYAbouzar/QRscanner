...
public class TheQrHiyaReadeActivity extends AppCompatActivity implements InterfaceConstan {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferencesUtilsLikeFlutter.initSharedReferences(TheQrHiyaReadeActivity.this);
